...
- 프로젝트
  ...
  - YangFlearn
    ...
    - 오 외부 DRM 솔루션으로 잘 만들어놨군. audio와 mp4를 쪼개서 206 Partial Content 받아와서 다시 재조립해서 스트리밍 할 수 있나보군.
    - 문제점 : 1. 동영상에서 사용자의 캡쳐 방지가 없다. (DRM으로 캡쳐기능을 막고 녹화방지 다운로드 방지를 막았다고 기술 되어 있지만 실제로 그렇지 않음) 2. 화면 녹화를 막히지 않았다.
    - 프로젝트 목표 : 동영상 캡쳐 방지 기능, 화면 녹화 방지 기능
- Life
